...
describe('Configuração do Ambiente de Testes - LOCAL', () => {
  it('Deve conectar ao banco PostgreSQL de testes', async () => {
    await sequelize.authenticate();
    expect(sequelize.config.database).to.equal('playlist_test');
  });

  it('Deve criar um usuário de teste no banco PostgreSQL', async () => {
